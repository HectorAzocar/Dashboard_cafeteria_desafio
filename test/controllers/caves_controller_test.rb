...
class CavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post caves_url, params: { cafe: { blend_name: @cafe.blend_name, origin: @cafe.origin, price: @cafe.price } }
    end
  ...
  test "should update cafe" do
    patch cafe_url(@cafe), params: { cafe: { blend_name: @cafe.blend_name, origin: @cafe.origin, price: @cafe.price } }
